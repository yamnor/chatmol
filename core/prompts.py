...
関連する・関係がありそうだ・適していると考えられる分子を「1 個」のみ選び、下記の手順に従って、最終案を出力してください。
...
検索結果から、それに関連する・関係がありそうだ・適していると考える分子の候補の中からランダムに「1 個」のみを選び、提案してください。
...
最も関連する・関係がありそうだ・適していると考えられる分子「1 個」のみを選び、下記の手順に従って、最終案を出力してください。

# 手順（１）: 候補とする分子の提案
 
ユーザーが指定した分子「{molecule_name}」に対して、「Google Search」を使用して、検索してください。

検索結果から、この分子に関連する・関係がありそうだ・適していると考えられる候補の分子の中からランダムに「1 個」のみを選び、提案してください。
